...
import { RiArrowDropDownLine } from "react-icons/ri";
 // Using a settings icon from react-icons
        ...
        header={
          <div className="header-row">
            <div className="header-select-all">
              ...
              {/* Adding the Icon next to Title */}
              <RiArrowDropDownLine onClick={toggleFloatingBox} style={{ cursor: 'pointer', marginRight: '10px' }} title="Select custom rows" />

              {/* Overlay panel for Image */}
